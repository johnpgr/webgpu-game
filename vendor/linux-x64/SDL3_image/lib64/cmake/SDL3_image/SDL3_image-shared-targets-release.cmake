...
set_target_properties(SDL3_image::SDL3_image-shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libSDL3_image.so.0.4.2"
  IMPORTED_SONAME_RELEASE "libSDL3_image.so.0"
  )

list(APPEND _cmake_import_check_targets SDL3_image::SDL3_image-shared )
list(APPEND _cmake_import_check_files_for_SDL3_image::SDL3_image-shared "${_IMPORT_PREFIX}/lib64/libSDL3_image.so.0.4.2" )
...
set_target_properties(SDL3_image::external_libpng PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libpng16.so.16.56.0"
  IMPORTED_SONAME_RELEASE "libpng16.so.16"
  )

list(APPEND _cmake_import_check_targets SDL3_image::external_libpng )
list(APPEND _cmake_import_check_files_for_SDL3_image::external_libpng "${_IMPORT_PREFIX}/lib64/libpng16.so.16.56.0" )
